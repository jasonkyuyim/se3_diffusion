...
import model.init_se3_tfmr as init
...
class SE3TransformerWrapper(nn.Module):
    ...
    def reset_parameter(self):
        ...
        self.se3.graph_modules[-1].to_kernel_self['0'] = init.lecun_normal_param(self.se3.graph_modules[-1].to_kernel_self['0'])
        self.se3.graph_modules[-1].to_kernel_self['1'] = init.lecun_normal_param(self.se3.graph_modules[-1].to_kernel_self['1'])
